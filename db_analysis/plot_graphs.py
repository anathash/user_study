...
if __name__ == "__main__":
    ...
    #plot_ctr('ctr_all','CTR per ad configuration', mode='save')
    #plot_ctr('ctr_direct_marketing','Direct Marketing CTR', mode='save')
    plot_ctr('ctr_indirect_marketing','Indirect Marketing CTR', mode='save')
